...
<div id='header'>
  ...
  <div id='help'>
    ...
    <div id='content'>
      ...
      <h2>Overview</h2>
      <div class='docstring'>
  <p>Our Task Class.</p><p>Available configuration is documented in <a href='../classes/Task.html#setConfig-instance'>::setConfig</a>.</p><p>Available events:</p><ul>
<li><code>started()</code> - emitted when we start execution</li>
<li><code>running()</code> - emitted when the method starts execution</li>
...
<li><code>completed(err, args...)</code> - emitted when execution exited, <code>args</code> are the result arguments from the method</li>
<li><code>error(err)</code> - emtited if an unexpected error occurs without ourself</li>
<li><code>done(err, args...)</code> - emitted when either execution completes (the <code>completed</code> event) or when an unexpected error occurs (the <code>error</code> event)</li>
...
<li><code>&#39;running&#39;</code> - execution of our method has begun</li>
<li><code>&#39;failed&#39;</code> - execution of our method has failed</li>
<li><code>&#39;passed&#39;</code> - execution of our method has succeeded</li>
...
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L165'>Source</a>
    </p>
    <div class='docstring'>
  <p>Creates a new <a href='../classes/Task.html'>Task</a> instance.</p>
</div>
<div class='tags'>
  <h3>Parameters:</h3>
  <ul class='param'>
  ...
  <div class='method_details'>
    <p class='signature' id='isTask-class'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L156'>Source</a>
    </p>
    <div class='docstring'>
  <p>A helper method to check if the passed argument is an instanceof a <a href='../classes/Task.html'>Task</a>.</p>
</div>
<div class='tags'>
  <h3>Parameters:</h3>
  <ul class='param'>
  ...
  <div class='method_details'>
    <p class='signature' id='constructor-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L187'>Source</a>
    </p>
    <div class='docstring'>
  <p>Initialize our new <a href='../classes/Task.html'>Task</a> instance. Forwards arguments onto <a href='../classes/Task.html#setConfig-instance'>::setConfig</a>.</p>
</div>
<div class='tags'>
</div>
  </div>
  ...
  <div class='method_details'>
    <p class='signature' id='destroy-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L349'>Source</a>
    </p>
    <div class='docstring'>
  <p>Destroy the task and prevent it from executing ever again.</p>
</div>
<div class='tags'>
</div>
  </div>
  <div class='method_details'>
    <p class='signature' id='hasExited-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L263'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='hasStarted-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L257'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='isComplete-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L275'>Source</a>
    </p>
    <div class='docstring'>
  <p>Have we completed its execution yet?</p>
</div>
<div class='tags'>
  <h3>Returns:</h3>
  <ul class='return'>
  ...
  <div class='method_details'>
    <p class='signature' id='isDestroyed-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L269'>Source</a>
    </p>
    <div class='docstring'>
  <p>Have we been destroyed?</p>
</div>
<div class='tags'>
  <h3>Returns:</h3>
  <ul class='return'>
  ...
  <div class='method_details'>
    <p class='signature' id='onceDone-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L333'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='run-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L412'>Source</a>
    </p>
    <div class='docstring'>
  <p>Start the execution of the task.</p><p>Will emit an <code>error</code> event if the task has already started before. </p>
</div>
<div class='tags'>
</div>
  </div>
  <div class='method_details'>
    <p class='signature' id='setConfig-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L216'>Source</a>
    </p>
    <div class='docstring'>
...
<div class='tags'>
  ...
  <div class='method_details'>
    <p class='signature' id='whenDone-instance'>
      ...
      <a class='gh-link' href='https:&#47;&#47;github.com&#47;bevry&#47;taskgroup
&#47;blob&#47;v4.0.2
/src&#47;lib&#47;taskgroup.coffee#L321'>Source</a>
    </p>
    <div class='docstring'>
